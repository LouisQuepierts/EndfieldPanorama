package net.quepierts.endfieldpanorama.neoforge.animation.raw;

import com.google.gson.JsonObject;
import lombok.RequiredArgsConstructor;
import net.minecraft.util.Mth;
import net.quepierts.endfieldpanorama.neoforge.animation.AnimatablePlayerModel;
import net.quepierts.endfieldpanorama.neoforge.animation.baked.BakedAnimation3f;
import net.quepierts.endfieldpanorama.neoforge.animation.baked.BakedTimeline3f;
...
public final class RawAnimation3f {
    ...
    private static void _bone(
        ...
        for (var entry : bone.entrySet()) {
            ...
            var multiplier  = switch (channel) {
                case "position" -> 0.0625f;
                case "rotation" -> Mth.DEG_TO_RAD;
                default -> 1.0f;
            };
            var timeline    = RawTimeline3f.fromJson(path, content.getAsJsonObject(), multiplier);
    ...
    public @NotNull BakedAnimation3f bake(@NotNull AnimatablePlayerModel model) {
        ...
        return new BakedAnimation3f(array, loop, length);
    }
