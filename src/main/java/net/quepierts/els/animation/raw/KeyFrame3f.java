...
public final class KeyFrame3f {
    ...
    public static KeyFrame3f fromJson(
        ...
        if (element.isJsonArray()) {
            ...
            return new KeyFrame3f(time, array[0], array[1], array[2], Interpolation.LINEAR);
            ...
            return new KeyFrame3f(time, pre[0], pre[1], pre[2], post[0], post[1], post[2], interpolation);
        }
    }
